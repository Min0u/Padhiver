...
public class Main {
    public static void main(String[] args) {
        ...
        // Création du joueur
        while (!choixMetier.equals("Barbare") && !choixMetier.equals("Guerrier") && !choixMetier.equals("Magicien")) {
            System.out.println("Choix invalide. Veuillez choisir un métier valide.");
            choixMetier = scanner.nextLine();
        }
        Joueur joueur = null;
        Metier metier = null;
        switch (choixMetier) {
        ...
        while (joueur.getNiveau() < 10 && joueur.getPointsDeVieCourants() > 0) {
            ...
            switch (choixAction) {
                ...
                case 1:
                    ...
                    for (Lieu lieu : joueur.getLieuActuel().getLieuxAccessibles(joueur.getLieuActuel())) {
