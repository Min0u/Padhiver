...
public class Jeu {
    public static void main(String[] args) {
        ...
        System.out.println("\nNom : " + joueur.getNom());
        System.out.println("Métier : " + joueur.getMetier());
        ...
        System.out.println("Dégâts : " + joueur.getDegats());
        ...
        while (joueur.getNiveau() < 10 && joueur.getPointsDeVieCourants() > 0) {
            // Afficher les informations du joueur ici...
            System.out.println("\nVous êtes à " + joueur.getLieuActuel().getNom() + ".");
            System.out.println("Vie : " + joueur.getPointsDeVieCourants() + "/" + joueur.getPointsDeVieTotal());
            System.out.println("Magie : " + joueur.getPointsDeMagieCourants() + "/" + joueur.getPointsDeMagieTotal());

            // Afficher les actions possibles ici...
            System.out.println("\nActions possibles :");
            ...
            // Lecture de l'entrée de l'utilisateur et exécution de l'action choisie ici...
            if (scanner.hasNextInt()) {
                ...
                switch (choixAction) {
                    case 1:
                        ...
                        for (int i = 0; i < lieuxAccessibles.size(); i++) {
                            ...
                            System.out.println((i + 1) + ". " + lieu.getNom());
                        }
                        ...
                        if (scanner.hasNextInt()) {
                            ...
                            scanner.nextLine(); // Consommer l'entrée invalide de l'utilisateur
                        }
                        break;
                    case 2:
                        if (joueur.getLieuActuel().getNbMonstres() == 0) {
                ...
                scanner.next(); // Consommer l'entrée invalide de l'utilisateur
            }
        }
